...
document
  .getElementById("download-cv-button")
  .addEventListener("click", function () {
    console.log("download CV button clicked");
    var link = document.createElement("a"); // Create an anchor element
    link.href =
      "https://github.com/SuryanshK/SuryanshK.github.io/raw/main/assets/most_recent_resume/Suryansh%20Khranger%20-%20Resume.pdf"; // Set the href attribute to the path of your resume file
...
document.querySelectorAll(".project-container").forEach((item, index) => {
  item.addEventListener("click", (event) => {
    ...
    const projectData = {
      title: event.currentTarget.querySelector(
        ".project-container-overlay-text-title"
      ).textContent,
      technology: event.currentTarget.querySelector(
        ".project-container-overlay-text-technology"
      ).textContent,
      information: event.currentTarget.querySelector(
        ".project-container-overlay-text-details"
      )
    ...
    document
      .querySelector(".close-expanded-display")
